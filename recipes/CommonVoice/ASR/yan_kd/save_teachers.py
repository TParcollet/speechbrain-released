        ...
        for num in range(self.hparams.num_tea):
            ...
            with torch.no_grad():
                ...
                predicted_words = self.tokenizer(
                    sequence_ctc, task="decode_from_list"
                )
                ...
                wer_stats_ctc = wer_details_for_batch(
                    ids, target_words, predicted_words
                )
                ...
                predicted_words_ce = self.tokenizer(
                    sequence_ce, task="decode_from_list"
                )

                wer_stats_ce = wer_details_for_batch(
                    ids, target_words, predicted_words_ce
                )
