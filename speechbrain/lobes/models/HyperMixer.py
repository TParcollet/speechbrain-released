...
class MixAndMLP(nn.Module):
    def __init__(
        ...
        self.positional_encoding = "fixed_abs_sine"
...
class HyperNetwork(nn.Module):
    ...
    def forward(self, position_embeddings: torch.Tensor):
        ...
        W1 = self.w1_gen(position_embeddings) / position_embeddings.size(1)
        W2 = self.w2_gen(position_embeddings) / position_embeddings.size(1)
